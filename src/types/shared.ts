...
export type TeknikArah =
    | 'kiri-kanan-atas-bawah-row'      // was: row
    | 'kanan-kiri-atas-bawah-row'      // was: row
    | 'kiri-kanan-bawah-atas-row'      // was: row
    | 'kanan-kiri-bawah-atas-row'      // was: row
    | 'atas-bawah-kiri-kanan-col'      // was: col
    | 'atas-bawah-kanan-kiri-col'      // was: col
    | 'bawah-atas-kiri-kanan-col'      // was: col
    | 'bawah-atas-kanan-kiri-col'      // was: col
