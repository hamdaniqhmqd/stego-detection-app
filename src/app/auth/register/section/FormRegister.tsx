...
export default function FormRegister() {
  ...
  return (
    <section className="form_register lg:py-20 sm:py-14 py-10 container mx-auto">
              ...
              <form className="form" onSubmit={handleSubmit}>
                <div className="form-group">
                  ...
                  <input
                    ...
                    className="block w-full px-4 h-[50px] mt-1 text-gray-700 placeholder-gray-500 bg-white border border-gray-400 rounded-lg focus:border-gray-900 focus:ring-opacity-40 focus:outline-none focus:ring focus:ring-gray-900"
